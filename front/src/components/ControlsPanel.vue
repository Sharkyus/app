<template>
    <div class="controls-panel" @mouseenter="$emit('prepare-click')" @touchstart="$emit('prepare-click')">
        <div class="controls-panel__rotate controls-panel__rotate_left" @click="$emit('rotate-left')">
            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1792 1792">
                <path d="M1664 896q0 156-61 298t-164 245-245 164-298 61q-172 0-327-72.5t-264-204.5q-7-10-6.5-22.5t8.5-20.5l137-138q10-9
                             ...
                             129q107-101 244.5-156.5t284.5-55.5q156 0 298 61t245 164 164 245 61 298z"></path>
            </svg>
        </div>
        <div class="controls-panel__rotate controls-panel__rotate-right" @click="$emit('rotate-right')">
            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1792 1792">
                <path d="M1664 256v448q0 26-19 45t-45 19h-448q-42 0-59-40-17-39 14-69l138-138q-148-137-349-137-104 0-198.5
                             ...
                             225-52t179-147q7-10 23-12 14 0 25 9l137 138q9 8 9.5 20.5t-7.5 22.5q-109 132-264 204.5t-327
                              ...
                              156.5l130-129q29-31 70-14 39 17 39 59z"></path>
            </svg>
        </div>
    </div>
</template>
